...
NCountry = {
	...
	SIBERIAN_FRONTIER_DAILY_BASE = 2.5,
	SIBERIAN_FRONTIER_DAILY_RANGE = 5.5,
...
NEconomy = {
	...
	TRADE_ADDED_VALUE_MODIFER = 0.001,
	TRADE_PROPAGATE_DIVIDER = 10,
	...
	CARAVAN_POWER_MAX = 25,
	CARAVAN_POWER_MIN = 0.5,
...
NMilitary = {
	...
	ARMY_DRILL_SKILL_MONTHS = 108,					-- The average number of months until you get a skill increase if drilling 100% of forcelimit. Set to 0 to disable.
	...
	CAVALRY_COST = 23, 							-- _MDEF_CAVALRY_COST = 10,
	...
	OVERRUN_FACTOR_CANNOT_LEAVE = 10,				-- Same as OVERRUN_FACTOR, but when combat cannot be left by the combattants. (integer)
...
NAI = {
	...
	DEBASE_THRESHOLD = 10,-- AI will not debase if it has more gold than this.
